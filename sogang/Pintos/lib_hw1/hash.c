           ...
           hash_hash_func *hash, hash_less_func *less, void *aux) 
{
  ...
  if (h->buckets != NULL) 
	...
	/*Based on an original suggestion on Robert Jenkin's part in 1997, I have done some research for a version of the integer hash function. This is my latest version as of January 2007. The specific value of the bit shifts are obtained from running the accompanied search program.(~x) + y is equivalent to y - x - 1 in two's complement representation.
